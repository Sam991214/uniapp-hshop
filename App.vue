...
<style>
	...
	@font-face {font-family: "iconfont";
	  src: url('http://121.4.255.161:9998/iconfont.eot?t=1576844226174'); /* IE9 */
	  src: url('http://121.4.255.161:9998/iconfont.eot?t=1576844226174#iefix') format('embedded-opentype'), /* IE6-IE8 */
	  ...
	  url('http://121.4.255.161:9998/iconfont.woff?t=1576844226174') format('woff'),
	  url('http://121.4.255.161:9998/iconfont.ttf?t=1576844226174') format('truetype'), /* chrome, firefox, opera, Safari, Android, iOS 4.2+ */
	  url('http://121.4.255.161:9998/iconfont.svg?t=1576844226174#iconfont') format('svg'); /* iOS 4.1- */
	}
